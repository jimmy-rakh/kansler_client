...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt $initGetIt({
    ...
    gh.factory<_i711.CartBloc>(() => _i711.CartBloc(
    ...
    gh.factory<_i375.SetUserNameUseCase>(
        () => _i375.SetUserNameUseCase(gh<_i892.AuthRepository>()));
    gh.factory<_i681.SendCodeUseCase>(
        () => _i681.SendCodeUseCase(gh<_i892.AuthRepository>()));
    gh.factory<_i236.LoginUseCase>(
        () => _i236.LoginUseCase(gh<_i892.AuthRepository>()));
    gh.factory<_i1070.GetAuthStatusUseCase>(
        () => _i1070.GetAuthStatusUseCase(gh<_i892.AuthRepository>()));
    gh.factory<_i16.ConfirmCodeUseCase>(
        () => _i16.ConfirmCodeUseCase(gh<_i892.AuthRepository>()));
    gh.factory<_i533.ClientPhoneNumbersUseCase>(
        () => _i533.ClientPhoneNumbersUseCase(gh<_i892.AuthRepository>()));
    gh.factory<_i977.CheckClientExistUseCase>(
        () => _i977.CheckClientExistUseCase(gh<_i892.AuthRepository>()));
    gh.factory<_i750.LogoutUseCase>(
        () => _i750.LogoutUseCase(gh<_i892.AuthRepository>()));
    gh.factory<_i574.LoginBloc>(() => _i574.LoginBloc(
          gh<_i236.LoginUseCase>(),
    ...
    gh.lazySingleton<_i188.AuthBloc>(() => _i188.AuthBloc(
          ...
          gh<_i750.LogoutUseCase>(),
        ));
    gh.factory<_i1023.RegisterBloc>(() => _i1023.RegisterBloc(
          gh<_i977.CheckClientExistUseCase>(),
          gh<_i533.ClientPhoneNumbersUseCase>(),
          gh<_i681.SendCodeUseCase>(),
          gh<_i375.SetUserNameUseCase>(),
          gh<_i1018.SetAuthTokenUseCase>(),
        ));
    ...
    gh.factory<_i86.ConfirmCodeBloc>(
        () => _i86.ConfirmCodeBloc(gh<_i16.ConfirmCodeUseCase>()));
    return this;
  }
}
