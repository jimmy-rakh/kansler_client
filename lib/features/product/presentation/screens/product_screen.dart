                                                            ...
                                                            children: [
                                                              ...
                                                              Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  text: (state.product ?? state.product)
                                                                              ?.inPreorder ??
                                                                          false
                                                                  ...
                                                                  textColor: context
                                                                      .onPrimary,
                                                                  fillColor: (state.product ?? state.product)
                                                                              ?.inPreorder ??
                                                                          false
                                                                      ? AppColors
                                                                          .red
                                                                      ...
                                                                      : Row(
                                                                          ...
                                                                          children: [
                                                                            state.product?.price == null
                                                                                ? const SizedBox()
                                                                                : Text('${currencyFormatter.format(state.product?.price).replaceAll(".", " ")} ${'common.sum'.tr()}'),
                                                                            if (!(state.product?.inCart ??
                                                                                false))
                                                                              SizedBox(
                                                                                child: AppCard(
