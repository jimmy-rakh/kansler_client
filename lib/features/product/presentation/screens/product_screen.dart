          ...
          body: ListView(
            children: [
              Row(
                ...
                children: [
                  AppCard(
                    width: context.isSmall ? context.width : context.width * .45,
                    borderRadius: context.isSmall ? 0 : 4,
                    margin:context.isSmall ? EdgeInsets.zero : const EdgeInsets.fromLTRB(20, 10, 0, 10),
                      ...
                      children: [
                        Padding(
                          ...
                          child: ImageNetwork(
                            ...
                            fitWeb: context.isSmall ? BoxFitWeb.contain : BoxFitWeb.contain,
                            height:context.isSmall ? context.height * .4 : context.height * .5,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: SizedBox(
                                        height: 50,
                                        width:context.isSmall ? context.width * .72 :context.width * .3 ,
                                        child: Row(
                                          mainAxisAlignment:
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      AppTextField(
                                                        fillColor: context.background,
                                                        height: 32,
                                                        width:context.isSmall ? context.width * .2 : context.width * .05,
                                                        radius: 0,
                                                        contentPadding:
                                                        const EdgeInsets.all(4),
                                    ...
                                    AppButton(
                                      ...
                                      fillColor: state.whenOrNull(
                                        success: (product) => product.leftQuantity ==
                                            0
                  ...
                  context.isSmall ? const SizedBox() : AppCard(
                    width: context.isSmall ? context.width : context.width * .45,
                    height:context.isSmall ? context.height * .3 : context.height * .624,
                    fillColor: context.cardColor,
                    padding: const EdgeInsets.only(bottom: 24),
                    margin: context.isSmall ? const EdgeInsets.all(8) : const EdgeInsets.fromLTRB(0, 10, 0, 0),
                    borderRadius: 4,
                    child: ListView(
                      children: [
                        verticalSpace12,
